				...
				<div class="ie-form__finance-help">
					...
					<div class="finance-help__payment-methods">
						...
						<div class="payment-methods__card-items">
							...
							<div class="card-items__item itemPrivat" onclick="showPrivat()" id="itemPrivat">
								<span class="itemPrivat__sign">Приват24</span>
								<span class="itemPrivat__name">Приват24</span>
							</div>
							<div class="card-items__item">
							...
							<div class="card-items__item itemPayPal" onclick="showPayPal()" id="itemPayPal">
								<img src="template/img/svg/paypal-sign.svg" class="itemPayPal__sign">
								<span class="itemPayPal__name">PayPal</span>
							</div>
						</div>
					</div>
					<div class="finance-help__enter-data" >
						...
						<div class="enter-data__card-data" id="privatForm">
						...
						<div class="enter-data__paypal-data" id="paypalForm">
